    ...
    <div class="bg-white rounded-lg shadow p-6">
        ...
        <div class="flex justify-between items-start mb-4">
            <div>
                ...
                <p class="text-sm text-gray-500">{{ $t('tasks.submitted') }}: {{ formatDate(submission.submittedAt) }}</p>
            </div>
            <div :class="[
        ...
        <div class="flex items-center mb-4 p-3 bg-gray-50 rounded-lg">
            ...
            <div>
                ...
                <p class="text-sm text-gray-500">{{ $t('tasks.fileUploaded') }}</p>
            </div>
        ...
        <div v-if="submission.isGraded" class="border-t pt-4">
            <div class="flex justify-between items-center mb-2">
                <span class="text-gray-600">{{ $t('tasks.score') }}:</span>
