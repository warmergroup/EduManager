                ...
                <div class="lg:col-span-1">
                    <div class="bg-white shadow rounded-lg p-6">
                        ...
                        <div class="space-y-4">
                            ...
                            <div class="flex justify-between">
                                <span class="text-gray-600">Yaratilgan vazifalar</span>
                                <span class="font-medium">{{ stats.totalTasks || 0 }}</span>
                            </div>
                            <div class="flex justify-between">
                                <span class="text-gray-600">Yaratilgan video darslar</span>
                                <span class="font-medium">{{ stats.totalVideos || 0 }}</span>
                            </div>
                            <div class="flex justify-between">
                                <span class="text-gray-600">Baholangan topshiriqlar</span>
                                <span class="font-medium">{{ stats.gradedSubmissions || 0 }}</span>
                            </div>
                        </div>
                    </div>
                </div>
